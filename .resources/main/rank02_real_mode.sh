...
start_exam() {
    clear
    bash label.sh
    echo "$(tput setaf 2)$(tput bold)🏊 Welcome to the Piscine 42 Exam!$(tput sgr0)"
    echo "=================================================="
    sleep 1
    ...
    clear
    echo "$(tput setaf 2)$(tput bold)🎉 Congratulations! You've completed the Piscine Exam!$(tput sgr0)"
    echo "=================================================="

...
stu=../../../../rendu/cycle_detector/cycle_detector.c
...
[ -s "$stu" ] || fail "${RED}Rien rendu dans rendu/cycle_detector/cycle_detector.c${RESET}"
gcc -I. -Wall -Wextra -Werror -o out2 "$stu" main.c 2>cc.log || fail "${RED}Compilation KO (-Wall -Wextra -Werror):${RESET}\n$(cat cc.log)"
gcc -I. -w -o out1 cycle_detector.c main.c 2>/dev/null || fail "${RED}Reference cassee${RESET}"

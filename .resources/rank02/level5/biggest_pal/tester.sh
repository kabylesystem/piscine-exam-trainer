...
EXO=biggest_pal; ref=$EXO.c; stu=../../../../rendu/$EXO/$EXO.c
...
check "abcba"
check "aaaaaaaaaabbcbbaaaa"
check "aooibdaoiwhoihwdoinzeldaisaboyobasiadlezfdsfnslk"
check "aeibaabaammaabaalek"
check "abeb" "qpinqwjobo"
check
